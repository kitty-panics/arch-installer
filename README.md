...
近几年 ArchISO 体积增长了 1GB 多，功能却没有什么显著变化，反而多次变更 linux 和 initrd
路径造成启动失败，误事。

遂以自己本地稳定运行 **五年+** 的 Arch Linux + Xfce4 桌面系统为蓝本，制作了一个镜像。
在保证轻量、美观的前提下，尽可能包含更多的维护工具。

既可用作快速安装镜像，也可替代 ArchISO 充当 Live 维护系统。
